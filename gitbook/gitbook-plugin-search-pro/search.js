...
/*
    ...
    gitbook.events.on('page.change', function (){
        ...
        sou2.css("margin-bottom","10px");
        if($(document).attr("title")=="管线 · GitBook"){
            sou2.append("<div id=\"book-search-input\" class=\"sou\" role=\"search\" style=\"padding-left: 10px;\">" +
                "<img src=\"../photos/ie.png\" id=\"pic\">"+
                "<input id=\"in\" style=\"padding: 1px 1px;background: white;border-radius:0px 0px 0px 0px;width: 195px;\" type=\"text\"  placeholder=\"搜索\" />"+
                "<button id=\"click1\">查询</button>"+
                "</div>"
            );
        }else {
            sou2.append("<div id=\"book-search-input\" class=\"sou\" role=\"search\" style=\"padding-left: 10px;\">" +
